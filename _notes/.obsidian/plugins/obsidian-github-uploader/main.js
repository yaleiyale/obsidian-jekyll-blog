...
var import_form_data2 = __toModule(require_browser());
...
var GHUploader = class extends import_obsidian2.Plugin {
          ...
          for (const file of files) {
            ...
            this.getBase64(file).then((baseFile) => {
              ...
              if (this.settings.random) {
                const start_suffix = file.name.lastIndexOf(".");
                filePath = this.settings.path + this.getFileName();
                filePath += start_suffix > 0 ? file.name.substring(start_suffix) : "";
              } else {
                filePath = this.settings.path + file.name;
              }
              const jsonBody = {
  ...
  async onload() {
    ...
    this.addSettingTab(new GHUploaderSettingTab(this.app, this));
  }
  onunload() {
