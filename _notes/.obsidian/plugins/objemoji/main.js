var x=Object.create;var m=Object.defineProperty;var j=Object.getOwnPropertyDescriptor;var E=Object.getOwnPropertyNames;var S=Object.getPrototypeOf,P=Object.prototype.hasOwnProperty;var w=a=>m(a,"__esModule",{value:!0});var T=(a,e)=>{w(a);for(var o in e)m(a,o,{get:e[o],enumerable:!0})},q=(a,e,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of E(e))!P.call(a,i)&&i!=="default"&&m(a,i,{get:()=>e[i],enumerable:!(o=j(e,i))||o.enumerable});return a},b=a=>q(w(m(a!=null?x(S(a)):{},"default",a&&a.__esModule&&"default"in a?{get:()=>a.default,enumerable:!0}:{value:a,enumerable:!0})),a);var t=(a,e,o)=>new Promise((i,s)=>{var c=n=>{try{u(o.next(n))}catch(h){s(h)}},l=n=>{try{u(o.throw(n))}catch(h){s(h)}},u=n=>n.done?i(n.value):Promise.resolve(n.value).then(c,l);u((o=o.apply(a,e)).next())});T(exports,{default:()=>p});var g=b(require("obsidian"));var r=JSON.parse(`{
  ":grinning:": "\u{1F600}",
  ":smiley:": "\u{1F603}",
  ":smile:": "\u{1F604}",
  ":grin:": "\u{1F601}",
...
}`);var f=a=>{var e;(e=a.innerText.match(/[:][^\s:][^ \n:]*[:]/g))==null||e.forEach(o=>k(o,a))};function k(a,e){var o;if(typeof e.tagName=="string"&&(e.tagName.includes("CODE")||e.tagName.includes("MJX")))return!1;e.hasChildNodes()?e.childNodes.forEach(i=>k(a,i)):e.textContent!==null&&(e.textContent=e.textContent.replace(a,(o=r[a])!=null?o:a))}var _=b(require("obsidian")),y={immediateReplace:!0,suggester:!0},d=class extends _.PluginSettingTab{constructor(e,o){super(e,o);this.plugin=o}display(){let{containerEl:e}=this;e.empty(),e.createEl("h2",{text:"OBJemoji"}),new _.Setting(e).setName("Immediate Emoji Replace").setDesc("If this is turned on, OBJemoji will be immediately replaced after typing. Otherwise they are still stored as a shortcode and you only see the Emoji in Preview Mode.").addToggle(o=>{o.setValue(this.plugin.settings.immediateReplace).onChange(i=>t(this,null,function*(){this.plugin.settings.immediateReplace=i,yield this.plugin.saveSettings()}))}),new _.Setting(e).setName("Emoji Suggester").setDesc("If this is turned on, a Suggester will appear everytime you type : followed by a letter. This will help you insert Emojis. (Doesn't work on mobile)").addToggle(o=>{o.setValue(this.plugin.settings.suggester).onChange(i=>t(this,null,function*(){this.plugin.settings.suggester=i,yield this.plugin.saveSettings()}))}),new _.Setting(e).setName("Donate").setDesc("If you like this Plugin, consider donating to support continued development:").addButton(o=>{o.buttonEl.outerHTML='<a id="coffee" href="https://lestua.eu.org/merger"> <img src="https://s1.ax1x.com/2022/10/30/xIMoKU.png" alt="BuyMeACoffee" width="180"> </a>'})}};var p=class extends g.Plugin{onload(){return t(this,null,function*(){yield this.loadSettings(),this.addSettingTab(new d(this.app,this)),this.registerEditorSuggest(new v(this)),this.registerMarkdownPostProcessor(f)})}loadSettings(){return t(this,null,function*(){this.settings=Object.assign({},y,yield this.loadData())})}saveSettings(){return t(this,null,function*(){yield this.saveData(this.settings)})}},v=class extends g.EditorSuggest{constructor(e){super(e.app);this.plugin=e}onTrigger(e,o,i){var s;if(this.plugin.settings.suggester){let c=o.getLine(e.line).substring(0,e.ch),l=(s=c.match(/:\S+$/))==null?void 0:s.first();if(l!==void 0)return{end:e,start:{ch:c.lastIndexOf(l),line:e.line},query:l}}return null}getSuggestions(e){let o=e.query.replace(":","");return Object.keys(r).filter(i=>i.includes(o))}renderSuggestion(e,o){let i=o.createDiv({cls:"ES-suggester-container"});i.createDiv({cls:"ES-shortcode"}).setText(e.replace(/:/g,"")),i.createDiv({cls:"ES-emoji"}).setText(r[e])}selectSuggestion(e){this.context!=null&&this.context.editor.replaceRange(this.plugin.settings.immediateReplace?r[e]:`${e} `,this.context.start,this.context.end)}};0&&(module.exports={});
